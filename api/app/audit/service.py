...
_METADATA_ALLOWLIST: dict[AuditEventType, set[str]] = {
    ...
    "SECURITY_FINDINGS_VIEWED": {
        "route",
        "returned_count",
        "critical_high_gate_passed",
        "pen_test_checklist_complete",
    },
    "SECURITY_FINDING_VIEWED": {"route", "finding_id", "status", "severity"},
    ...
    "RISK_ACCEPTANCE_REVOKED": {"route", "risk_acceptance_id", "status"},
    ...
    "SEARCH_INDEX_ACTIVATED": {"route", "index_id", "status", "version"},
    ...
    "DERIVATIVE_INDEX_ACTIVATED": {"route", "index_id", "status", "version"},
    ...
    "INDEX_QUALITY_DETAIL_VIEWED": {
        ...
        "rollback_eligible",
        "search_activation_blocker_count",
    },
    ...
    "RUNBOOK_LIST_VIEWED": {"route", "returned_count"},
    ...
    "INCIDENT_LIST_VIEWED": {"route", "returned_count", "open_incident_count"},
    ...
    "INCIDENT_VIEWED": {"route", "incident_id", "severity", "status"},
    "INCIDENT_TIMELINE_VIEWED": {"route", "incident_id", "returned_count"},
