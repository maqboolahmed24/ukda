...
TranscriptionConfidenceBand = Literal["HIGH", "MEDIUM", "LOW", "UNKNOWN"]
...
TranscriptVariantSuggestionDecision = Literal["ACCEPT", "REJECT"]
TranscriptionFallbackReasonCode = Literal[
...
class PageTranscriptionResultRecord:
    ...
    created_at: datetime
    updated_at: datetime
    reviewer_assignment_user_id: str | None = None
    reviewer_assignment_updated_by: str | None = None
    reviewer_assignment_updated_at: datetime | None = None
...
class LineTranscriptionResultRecord:
    ...
    created_at: datetime
    updated_at: datetime
    confidence_band: TranscriptionConfidenceBand = "UNKNOWN"
...
@dataclass(frozen=True)
class TranscriptionCompareDecisionRecord:
    id: str
    document_id: str
    base_run_id: str
...
@dataclass(frozen=True)
class TranscriptionCompareDecisionEventRecord:
    id: str
    ...
    line_id: str | None
    token_id: str | None
    from_decision: TranscriptionCompareDecision | None
    to_decision: TranscriptionCompareDecision
    actor_user_id: str
    reason: str | None
    created_at: datetime
...
@dataclass(frozen=True)
class TranscriptVariantLayerRecord:
    id: str
    run_id: str
    page_id: str
    variant_kind: TranscriptVariantKind
    base_transcript_version_id: str | None
    base_version_set_sha256: str | None
    base_projection_sha256: str
    variant_text_key: str
...
@dataclass(frozen=True)
class TranscriptVariantSuggestionRecord:
    id: str
...
@dataclass(frozen=True)
class TranscriptVariantSuggestionEventRecord:
    id: str
    suggestion_id: str
    variant_layer_id: str
    actor_user_id: str
    decision: TranscriptVariantSuggestionDecision
    from_status: TranscriptVariantSuggestionStatus
