...
- Runtime promotion path is `dev -> staging -> prod` through the gated deploy workflow.
...
- It includes dedicated API and worker service-account templates with token automount disabled by default.
