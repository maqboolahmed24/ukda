...
"[project]/web/lib/data/cache-policy.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/web/lib/data/api-types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/web/lib/data/query-keys.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/web/lib/data/browser-api-client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$cache$2d$policy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/lib/data/cache-policy.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/lib/data/api-types.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$query$2d$keys$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/lib/data/query-keys.ts [app-client] (ecmascript)");
;
;
;
...
async function requestBrowserApi(options) {
    const method = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeMethod"])(options.method);
    const policy = __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$cache$2d$policy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryCachePolicy"][options.cacheClass ?? "operations-live"];
    ...
    if (options.queryKey) {
        headers.set("X-UKDE-Query-Key", (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$query$2d$keys$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serializeQueryKey"])(options.queryKey));
    }
    let response;
    try {
        ...
        return {
            ...
            error: {
                code: "NETWORK",
                detail: "API is unavailable.",
                retryable: (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveRetryable"])("NETWORK", method)
            }
        };
    }
    if (options.expectNoContent || response.status === 204) {
        return {
            ...
            ...response.ok ? {} : {
                ...
                error: {
                    code: (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveErrorCode"])(response.status),
                    detail: "Request failed.",
                    retryable: (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveRetryable"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveErrorCode"])(response.status), method)
                }
            }
        };
    }
    ...
    if (!response.ok) {
        const code = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveErrorCode"])(response.status);
        const detail = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeDetail"])(parsed);
        return {
            ok: false,
            status: response.status,
            detail,
            error: {
                code,
                detail,
                retryable: (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$api$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveRetryable"])(code, method)
            }
        };
    }
    return {
...
"[project]/web/components/document-preprocess-run-actions.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2f$src$2f$primitives$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/ui/src/primitives.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$browser$2d$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/lib/data/browser-api-client.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/lib/routes.ts [app-client] (ecmascript)");
;
...
function DocumentPreprocessRunActions({ canMutate, documentId, isActiveProjection = false, projectId, runId, runStatus }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$playwright$2b$test$40$1$2e$58$2e$2_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DocumentPreprocessRunActions.useEffect": ()=>{
    ...
    async function triggerCreate() {
        ...
        setError(null);
        setSuccess(null);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$data$2f$browser$2d$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["requestBrowserApi"])({
            method: "POST",
        ...
        router.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectDocumentPreprocessingRunPath"])(projectId, documentId, result.data.id));
        router.refresh();
    }
...
_s(DocumentPreprocessRunActions, "KJFPe0djSo1SUpPlwLEQhjUbhac=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$playwright$2b$test$40$1$2e$58$2e$2_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = DocumentPreprocessRunActions;
var _c;
__turbopack_context__.k.register(_c, "DocumentPreprocessRunActions");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=web_a1adf79e._.js.map